...
def ask_api(
    ...
    _data = {
        ...
        'envs': {
            ...
            'OPENAI_DEPLOYMENT': openAI_engine,
        },
    }
...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        with gr.Group():
            ...
            gr.Markdown(
                '<p style="text-align:center">Get your Azure OpenAI API variables  <a href="https://learn.microsoft.com/en-us/azure/cognitive-services/openai/quickstart?tabs=command-line&pivots=programming-language-python">here</a></p>'
            )
            openAI_key = gr.Textbox(
                label='Enter your OpenAI API key here', type='password'
            )
            openAI_base = gr.Textbox(
                label='Enter your OpenAI API endpoint'
            )
            openAI_engine = gr.Textbox(
                label="Enter your OpenAI model deployment name"
            )
